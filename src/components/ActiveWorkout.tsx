    ...
    <div className="max-w-5xl mx-auto space-y-10 pb-20 fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-10 border-b border-white/5">
        <div className="flex items-start gap-6">
          <div className="h-20 w-20 rounded-[2.5rem] bg-primary/10 border border-primary/20 flex items-center justify-center text-5xl shadow-2xl shadow-primary/10">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                    ...
                    {currentExercise.sets?.map((s, i) => (
                      <div
                        ...
                        className={`h-2.5 w-10 rounded-full transition-all duration-500 ${i === activeSetIndex
                          ? 'bg-primary shadow-lg shadow-primary/40 w-16'
                ...
                <Button
                  ...
                  className="h-20 text-2xl font-bold rounded-[2rem] shadow-2xl shadow-primary/30"
                >
